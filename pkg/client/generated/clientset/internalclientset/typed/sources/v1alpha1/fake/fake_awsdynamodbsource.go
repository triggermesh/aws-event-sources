...
func (c *FakeAWSDynamoDBSources) List(opts v1.ListOptions) (result *v1alpha1.AWSDynamoDBSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAWSDynamoDBSources) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAWSDynamoDBSources) Create(aWSDynamoDBSource *v1alpha1.AWSDynamoDBSource) (result *v1alpha1.AWSDynamoDBSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeAWSDynamoDBSources) Update(aWSDynamoDBSource *v1alpha1.AWSDynamoDBSource) (result *v1alpha1.AWSDynamoDBSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeAWSDynamoDBSources) UpdateStatus(aWSDynamoDBSource *v1alpha1.AWSDynamoDBSource) (*v1alpha1.AWSDynamoDBSource, error) {
	obj, err := c.Fake.
...
func (c *FakeAWSDynamoDBSources) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAWSDynamoDBSources) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(awsdynamodbsourcesResource, c.ns, listOptions)
...
func (c *FakeAWSDynamoDBSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AWSDynamoDBSource, err error) {
	obj, err := c.Fake.
