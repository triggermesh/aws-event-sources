...
func Get(ctx context.Context) v1alpha1.AWSCloudWatchLogSourceInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/aws-event-sources/pkg/client/generated/informers/externalversions/sources/v1alpha1.AWSCloudWatchLogSourceInformer from context.")
	}
	return untyped.(v1alpha1.AWSCloudWatchLogSourceInformer)
}
