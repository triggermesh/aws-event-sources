...
func Get(ctx context.Context, selector string) v1alpha1.AWSCloudWatchLogsSourceInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/triggermesh/aws-event-sources/pkg/client/generated/informers/externalversions/sources/v1alpha1.AWSCloudWatchLogsSourceInformer with selector %s from context.", selector)
	}
