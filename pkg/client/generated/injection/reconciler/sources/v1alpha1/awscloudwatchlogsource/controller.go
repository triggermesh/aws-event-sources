...
const (
	defaultControllerAgentName = "awscloudwatchlogsource-controller"
	defaultFinalizerName       = "awscloudwatchlogsources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	awscloudwatchlogsourceInformer := awscloudwatchlogsource.Get(ctx)

	lister := awscloudwatchlogsourceInformer.Lister()
