...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.AWSCognitoIdentitySources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.AWSCognitoIdentitySource, desired *v1alpha1.AWSCognitoIdentitySource) error {
