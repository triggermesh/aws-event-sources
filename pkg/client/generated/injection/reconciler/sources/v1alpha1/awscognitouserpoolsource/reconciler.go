...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.AWSCognitoUserPoolSources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.AWSCognitoUserPoolSource, desired *v1alpha1.AWSCognitoUserPoolSource) error {
