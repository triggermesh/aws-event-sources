...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.AWSDynamoDBSources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.AWSDynamoDBSource, desired *v1alpha1.AWSDynamoDBSource) error {
