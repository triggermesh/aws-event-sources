...
import (
	...
	awsdynamodbsource "github.com/triggermesh/aws-event-sources/pkg/client/generated/injection/reconciler/sources/v1alpha1/awsdynamodbsource"
...
// reason AWSDynamoDBSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "AWSDynamoDBSourceReconciled", "AWSDynamoDBSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for AWSDynamoDBSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ awsdynamodbsource.Interface = (*Reconciler)(nil)
...
//var _ awsdynamodbsource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ awsdynamodbsource.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.AWSDynamoDBSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.AWSDynamoDBSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
