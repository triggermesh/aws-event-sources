...
import (
	...
	awsiotsource "github.com/triggermesh/aws-event-sources/pkg/client/generated/injection/reconciler/sources/v1alpha1/awsiotsource"
...
// reason AWSIoTSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "AWSIoTSourceReconciled", "AWSIoTSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for AWSIoTSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ awsiotsource.Interface = (*Reconciler)(nil)
...
//var _ awsiotsource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ awsiotsource.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.AWSIoTSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.AWSIoTSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
