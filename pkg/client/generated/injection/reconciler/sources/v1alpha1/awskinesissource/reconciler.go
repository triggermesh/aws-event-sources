...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.AWSKinesisSources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.AWSKinesisSource, desired *v1alpha1.AWSKinesisSource) error {
