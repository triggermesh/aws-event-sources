...
import (
	...
	awskinesissource "github.com/triggermesh/aws-event-sources/pkg/client/generated/injection/reconciler/sources/v1alpha1/awskinesissource"
...
// reason AWSKinesisSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "AWSKinesisSourceReconciled", "AWSKinesisSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for AWSKinesisSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ awskinesissource.Interface = (*Reconciler)(nil)
...
//var _ awskinesissource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ awskinesissource.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.AWSKinesisSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.AWSKinesisSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
