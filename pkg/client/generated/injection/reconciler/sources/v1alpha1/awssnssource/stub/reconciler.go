...
import (
	...
	awssnssource "github.com/triggermesh/aws-event-sources/pkg/client/generated/injection/reconciler/sources/v1alpha1/awssnssource"
...
// reason AWSSNSSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "AWSSNSSourceReconciled", "AWSSNSSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for AWSSNSSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ awssnssource.Interface = (*Reconciler)(nil)
...
//var _ awssnssource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ awssnssource.ReadOnlyFinalizer = (*Reconciler)(nil)
...
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.AWSSNSSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.AWSSNSSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
