...
type adapterConfig struct {
	// Container image
	Image string `default:"gcr.io/triggermesh/awscodecommit"`
...
func (r *Reconciler) reconcileAdapter(ctx context.Context,
	src *v1alpha1.AWSCodeCommitSource) (*appsv1.Deployment, error) {
...
func (r *Reconciler) syncAdapterDeployment(ctx context.Context, src *v1alpha1.AWSCodeCommitSource,
...
func makeAdapterDeployment(src *v1alpha1.AWSCodeCommitSource, sinkURI string,
	...
	return resource.NewDeployment(src.Namespace, name,
		...
		resource.EnvVar(eventsEnvVar, strings.Join(src.Spec.Events, ",")),
