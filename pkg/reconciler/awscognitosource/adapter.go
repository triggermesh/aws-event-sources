...
func (r *Reconciler) reconcileAdapter(ctx context.Context,
	src *v1alpha1.AWSCognitoSource) (*appsv1.Deployment, error) {
...
func (r *Reconciler) getOrCreateAdapter(ctx context.Context, src *v1alpha1.AWSCognitoSource,
...
func (r *Reconciler) syncAdapterDeployment(ctx context.Context, src *v1alpha1.AWSCognitoSource,
...
func makeAdapterDeployment(src *v1alpha1.AWSCognitoSource, sinkURI string,
