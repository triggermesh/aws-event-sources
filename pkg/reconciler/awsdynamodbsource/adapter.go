...
type adapterConfig struct {
	// Container image
	Image string `default:"gcr.io/triggermesh/awsdynamodb"`
...
func (r *Reconciler) reconcileAdapter(ctx context.Context,
	src *v1alpha1.AWSDynamoDBSource) (*appsv1.Deployment, error) {
...
func (r *Reconciler) getOrCreateAdapter(ctx context.Context, src *v1alpha1.AWSDynamoDBSource,
...
func (r *Reconciler) syncAdapterDeployment(ctx context.Context, src *v1alpha1.AWSDynamoDBSource,
...
func makeAdapterDeployment(src *v1alpha1.AWSDynamoDBSource, sinkURI string,
	...
	return resource.NewDeployment(src.Namespace, name,
		...
		resource.EnvVar(tableEnvVar, src.Spec.Table),
