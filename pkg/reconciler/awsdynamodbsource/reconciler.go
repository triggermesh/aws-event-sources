...
//var _ awsdynamodbsource.Finalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.AWSDynamoDBSource) pkgreconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.AWSDynamoDBSource) pkgreconciler.Event {
