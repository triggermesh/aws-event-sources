...
func (r *Reconciler) reconcileAdapter(ctx context.Context,
	src *v1alpha1.AWSIoTSource) (*appsv1.Deployment, error) {
...
func (r *Reconciler) getOrCreateAdapter(ctx context.Context, src *v1alpha1.AWSIoTSource,
...
func (r *Reconciler) syncAdapterDeployment(ctx context.Context, src *v1alpha1.AWSIoTSource,
...
func makeAdapterDeployment(src *v1alpha1.AWSIoTSource, sinkURI string,
