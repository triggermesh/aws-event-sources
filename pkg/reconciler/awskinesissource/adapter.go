...
type adapterConfig struct {
	// Container image
	Image string `default:"gcr.io/triggermesh/awskinesis"`
...
func (r *Reconciler) reconcileAdapter(ctx context.Context,
	src *v1alpha1.AWSKinesisSource) (*appsv1.Deployment, error) {
...
func (r *Reconciler) getOrCreateAdapter(ctx context.Context, src *v1alpha1.AWSKinesisSource,
...
func (r *Reconciler) syncAdapterDeployment(ctx context.Context, src *v1alpha1.AWSKinesisSource,
...
func makeAdapterDeployment(src *v1alpha1.AWSKinesisSource, sinkURI string,
	...
	return resource.NewDeployment(src.Namespace, name,
		...
		resource.EnvVar(streamEnvVar, src.Spec.Stream),
